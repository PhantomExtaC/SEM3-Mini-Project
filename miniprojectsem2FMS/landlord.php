...
<body>
    <nav>
        ...
        <ul>
            ...
            <li class="active"><a href="landlord.php">View Listings</a></li>
            <li><a href="reviews_owner.php">View Reviews</a></li>
            <li><a href="view_tickets.php">View Tickets</a></li>
        </ul>
        <button class="login"><a href="includes/logout.php">Login</a></button>
    </nav>
